...
CREATE TABLE `board` (
  ...
  `writer_pw` varchar(200) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT '비밀번호 (비회원 작성용)',
  ...
  `use_yn` char(1) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT 'Y' COMMENT '사용여부 (Y:사용, N:미사용)',
...
INSERT INTO `board` VALUES (3,'fdgsdf','hjjghjghjgjhgㅁㄴㅇㅁㄴㅇㅁㄴㅇㅁ','1234',3,0,NULL,15,'Y',5,NULL,'2026-04-26 12:55:42','2026-04-26 13:32:48',NULL),(4,'ㅁㄴㅇ','ㅁㄴㅇ','1234',4,0,NULL,7,'Y',5,NULL,'2026-04-26 13:32:46','2026-05-11 13:53:43',NULL);
...
CREATE TABLE `menu` (
  ...
  `sort_ord` int DEFAULT '0' COMMENT '정렬 순서 (같은  부모를 가진 그룹)',
  `use_yn` char(1) DEFAULT 'Y' COMMENT '사용여부 (Y:사용, N:미사용)',
...
) ENGINE=InnoDB AUTO_INCREMENT=34 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='메뉴 관리 테이블 (계층 구조 + 프로그램 연결)';
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `menu` VALUES (1,'게시판',NULL,0,0,'Y',NULL,'2026-04-24 00:50:56',0,'2026-04-24 00:50:56',0),(2,'시스템',NULL,0,1,'Y',NULL,'2026-04-24 00:50:56',0,'2026-05-11 11:31:43',0),(3,'일반게시판',1,1,0,'Y',1,'2026-04-24 00:50:56',0,'2026-04-24 01:00:12',0),(4,'이미지게시판',1,1,1,'Y',2,'2026-04-24 00:50:56',0,'2026-04-24 01:00:12',0),(5,'사용자관리',2,1,0,'Y',3,'2026-04-24 00:50:56',0,'2026-04-24 01:00:12',0),(6,'설문',NULL,0,2,'Y',NULL,'2026-05-05 06:32:57',NULL,'2026-05-11 11:31:43',NULL),(7,'권한관리',NULL,0,3,'Y',NULL,'2026-05-05 06:32:57',NULL,'2026-05-11 11:31:43',NULL),(8,'설문관리',6,1,0,'Y',4,'2026-05-05 06:32:57',NULL,'2026-05-05 06:32:57',NULL),(10,'설문참여',6,1,1,'Y',6,'2026-05-05 06:32:57',NULL,'2026-05-11 11:32:03',NULL),(11,'권한그룹관리',7,1,0,'Y',7,'2026-05-05 06:32:57',NULL,'2026-05-05 06:32:57',NULL),(12,'메뉴별권한관리',7,1,1,'Y',8,'2026-05-05 06:32:57',NULL,'2026-05-05 06:32:57',NULL),(13,'권한별사용자관리',7,1,2,'Y',9,'2026-05-05 06:32:57',NULL,'2026-05-05 06:32:57',NULL),(33,'테스트 메뉴',13,2,0,'Y',NULL,'2026-05-11 10:45:42',NULL,'2026-05-11 10:45:42',NULL);
...
CREATE TABLE `menu_role_perm` (
  ...
  `disp_perm` char(1) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci DEFAULT 'N' COMMENT '메뉴 표시 권한 (사이드바 노출여부)',
  `view_perm` char(1) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci DEFAULT 'N' COMMENT '프로그램 조회 권한 (URL 직접 접근)',
  `ins_perm` char(1) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci DEFAULT 'N' COMMENT '등록 권한',
  `upd_perm` char(1) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci DEFAULT 'N' COMMENT '수정 권한',
  `del_perm` char(1) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci DEFAULT 'N' COMMENT '삭제 권한',
  `reg_user` int DEFAULT NULL COMMENT 'FK) 등록자 users.user_no',
  `reg_date` datetime DEFAULT CURRENT_TIMESTAMP COMMENT '등록일시',
  `mod_user` int DEFAULT NULL COMMENT 'FK) 수정자 users.user_no',
  `mod_date` datetime DEFAULT NULL COMMENT '수정일시',
  PRIMARY KEY (`perm_no`),
...
) ENGINE=InnoDB AUTO_INCREMENT=52 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='메뉴별 롤 권한 관리 테이블';
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `menu_role_perm` VALUES (1,1,3,'Y','Y','Y','Y','Y',5,'2026-05-11 08:56:23',NULL,NULL),(2,2,3,'Y','Y','Y','Y','Y',5,'2026-05-11 08:56:23',NULL,NULL),(3,3,3,'Y','Y','Y','Y','Y',5,'2026-05-11 08:56:23',NULL,NULL),(4,4,3,'Y','Y','Y','Y','Y',5,'2026-05-11 08:56:23',NULL,NULL),(5,5,3,'Y','Y','Y','Y','Y',5,'2026-05-11 08:56:23',NULL,NULL),(6,6,3,'Y','Y','Y','Y','Y',5,'2026-05-11 08:56:23',NULL,NULL),(7,7,3,'Y','Y','Y','Y','Y',5,'2026-05-11 08:56:23',NULL,NULL),(8,8,3,'Y','Y','Y','Y','Y',5,'2026-05-11 08:56:23',NULL,NULL),(9,10,3,'Y','Y','Y','Y','Y',5,'2026-05-11 08:56:23',NULL,NULL),(10,11,3,'Y','Y','Y','Y','Y',5,'2026-05-11 08:56:23',NULL,NULL),(11,12,3,'Y','Y','Y','Y','Y',5,'2026-05-11 08:56:23',NULL,NULL),(12,13,3,'Y','Y','Y','Y','Y',5,'2026-05-11 08:56:23',NULL,NULL),(13,1,2,'Y','Y','Y','Y','Y',5,'2026-05-11 08:56:23',5,'2026-05-11 09:00:30'),(14,2,2,'Y','Y','Y','Y','Y',5,'2026-05-11 08:56:23',5,'2026-05-11 09:00:30'),(15,3,2,'Y','Y','Y','Y','Y',5,'2026-05-11 08:56:23',5,'2026-05-11 09:00:30'),(16,4,2,'Y','Y','Y','Y','Y',5,'2026-05-11 08:56:23',5,'2026-05-11 09:00:30'),(17,5,2,'Y','Y','Y','Y','Y',5,'2026-05-11 08:56:23',5,'2026-05-11 09:00:30'),(18,6,2,'Y','Y','Y','Y','Y',5,'2026-05-11 08:56:23',5,'2026-05-11 09:00:30'),(19,7,2,'Y','Y','Y','Y','Y',5,'2026-05-11 08:56:23',5,'2026-05-11 09:00:30'),(20,8,2,'Y','Y','Y','Y','Y',5,'2026-05-11 08:56:23',5,'2026-05-11 09:00:30'),(21,10,2,'Y','Y','Y','Y','Y',5,'2026-05-11 08:56:23',5,'2026-05-11 09:00:30'),(22,11,2,'Y','Y','Y','Y','Y',5,'2026-05-11 08:56:23',5,'2026-05-11 09:00:30'),(23,12,2,'Y','Y','Y','Y','Y',5,'2026-05-11 08:56:23',5,'2026-05-11 09:00:30'),(24,13,2,'Y','Y','Y','Y','Y',5,'2026-05-11 08:56:23',5,'2026-05-11 09:00:30'),(25,1,1,'Y','Y','Y','Y','Y',5,'2026-05-11 08:56:23',5,'2026-05-11 09:03:35'),(26,2,1,'Y','N','N','N','N',5,'2026-05-11 08:56:23',5,'2026-05-11 09:03:35'),(27,3,1,'Y','Y','Y','Y','Y',5,'2026-05-11 08:56:23',5,'2026-05-11 09:03:35'),(28,4,1,'Y','N','N','N','N',5,'2026-05-11 08:56:23',5,'2026-05-11 09:03:35'),(29,5,1,'Y','N','N','N','N',5,'2026-05-11 08:56:23',5,'2026-05-11 09:03:35'),(30,6,1,'Y','N','N','N','N',5,'2026-05-11 08:56:23',5,'2026-05-11 09:03:35'),(31,7,1,'Y','N','N','N','N',5,'2026-05-11 08:56:23',5,'2026-05-11 09:03:35'),(32,8,1,'Y','N','N','N','N',5,'2026-05-11 08:56:23',5,'2026-05-11 09:03:35'),(33,10,1,'Y','N','N','N','N',5,'2026-05-11 08:56:23',5,'2026-05-11 09:03:35'),(34,11,1,'Y','N','N','N','N',5,'2026-05-11 08:56:23',5,'2026-05-11 09:03:35'),(35,12,1,'Y','N','N','N','N',5,'2026-05-11 08:56:23',5,'2026-05-11 09:03:35'),(36,13,1,'Y','N','N','N','N',5,'2026-05-11 08:56:23',5,'2026-05-11 09:03:35'),(37,1,7,'N','N','N','N','N',5,'2026-05-11 09:07:12',NULL,NULL),(38,2,7,'N','N','N','N','N',5,'2026-05-11 09:07:12',NULL,NULL),(39,3,7,'N','N','N','N','N',5,'2026-05-11 09:07:12',NULL,NULL),(40,4,7,'N','N','N','N','N',5,'2026-05-11 09:07:12',NULL,NULL),(41,5,7,'N','N','N','N','N',5,'2026-05-11 09:07:12',NULL,NULL),(42,6,7,'N','N','N','N','N',5,'2026-05-11 09:07:12',NULL,NULL),(43,7,7,'N','N','N','N','N',5,'2026-05-11 09:07:12',NULL,NULL),(44,8,7,'N','N','N','N','N',5,'2026-05-11 09:07:12',NULL,NULL),(45,10,7,'N','N','N','N','N',5,'2026-05-11 09:07:12',NULL,NULL),(46,11,7,'N','N','N','N','N',5,'2026-05-11 09:07:12',NULL,NULL),(47,12,7,'N','N','N','N','N',5,'2026-05-11 09:07:12',NULL,NULL),(48,13,7,'N','N','N','N','N',5,'2026-05-11 09:07:12',NULL,NULL);
...
CREATE TABLE `q_option` (
  ...
  `mod_user` int DEFAULT NULL COMMENT 'FK) users.user_no 수정자',
  `mod_date` datetime DEFAULT NULL COMMENT '수정일시',
  `use_yn` char(1) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci DEFAULT 'Y' COMMENT '사용여부 (논리삭제용)',
...
) ENGINE=InnoDB AUTO_INCREMENT=32 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='질문 보기(선택지) 테이블';
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `q_option` VALUES (18,34,'r1',0,NULL,'2026-05-06 00:23:27',NULL,NULL,'Y'),(19,34,'r2',1,NULL,'2026-05-06 00:23:27',NULL,NULL,'Y'),(20,34,'r3',2,NULL,'2026-05-06 00:23:27',NULL,NULL,'Y'),(21,37,'ㅅ1',0,NULL,'2026-05-06 00:26:49',NULL,NULL,'Y'),(22,37,'ㅅ2',1,NULL,'2026-05-06 00:26:49',NULL,NULL,'Y'),(23,37,'ㅅ3',2,NULL,'2026-05-06 00:26:49',NULL,NULL,'Y'),(24,38,'ㄱㄱㄱㄱ',0,NULL,'2026-05-06 07:54:12',NULL,NULL,'N'),(25,38,'ㄷㄷㄷㄷㄷ',1,NULL,'2026-05-06 07:54:12',NULL,NULL,'N'),(26,38,'ㄴㄴㄴㄴㄴ',0,NULL,'2026-05-06 07:54:12',NULL,NULL,'Y'),(27,41,'ㅂㅂㅂㅂ',0,NULL,'2026-05-06 16:00:06',NULL,NULL,'Y'),(28,42,'거미',0,NULL,'2026-05-11 14:27:53',NULL,NULL,'Y'),(29,42,'호랑이',1,NULL,'2026-05-11 14:27:53',NULL,NULL,'Y'),(30,42,'사마귀',2,NULL,'2026-05-11 14:27:53',NULL,NULL,'Y'),(31,42,'개미',3,NULL,'2026-05-11 14:27:53',NULL,NULL,'Y');
...
CREATE TABLE `question` (
  `board_no` int NOT NULL COMMENT '질문 PK (board_no 시퀀스 공용)',
  `survey_no` int NOT NULL COMMENT 'FK) survey.survey_no',
  `content` text NOT NULL COMMENT '질문 내용',
  `type` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NOT NULL COMMENT 'FK) code.code_no 질문 타입 (radio, text 등)',
...
INSERT INTO `question` VALUES (34,5,'radio q','radio',0,NULL,5,'2026-05-06 00:23:27',5,'2026-05-06 00:42:50','Y'),(35,5,'aaaaa','textarea',1,NULL,5,'2026-05-06 00:23:27',5,'2026-05-06 00:42:50','Y'),(36,6,'단답질문','text',0,NULL,5,'2026-05-06 00:26:49',NULL,NULL,'Y'),(37,6,'셀렉트질문','select',1,NULL,5,'2026-05-06 00:26:49',NULL,NULL,'Y'),(38,7,'ㅓㅗㅓㅗㅓㅗ','radio',0,NULL,5,'2026-05-06 07:54:12',5,'2026-05-06 16:07:11','Y'),(39,7,'ㅎㅎㅎㅎ','textarea',1,NULL,5,'2026-05-06 07:54:12',5,'2026-05-06 16:07:11','Y'),(41,9,'ㄴㅁㅇ','radio',0,NULL,5,'2026-05-06 16:00:06',NULL,NULL,'Y'),(42,10,'2번 셀렉트박스입니다','select',1,NULL,5,'2026-05-11 14:27:53',5,'2026-05-11 14:28:34','Y'),(43,10,'1번 질문입니다.','text',0,NULL,5,'2026-05-11 14:27:53',5,'2026-05-11 14:28:34','Y');
...
CREATE TABLE `response` (
  ...
  PRIMARY KEY (`res_no`),
  UNIQUE KEY `response_unique` (`survey_no`,`reg_user`),
...
) ENGINE=InnoDB AUTO_INCREMENT=8 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='설문 응답 헤더 (중복참여 방지 UNIQUE) (한 사람이 한 설문에 참여한 기록)';
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `response` VALUES (2,6,5,'2026-05-06 00:41:34',NULL,NULL,'Y'),(3,6,6,'2026-05-06 02:33:37',NULL,NULL,'Y'),(4,5,6,'2026-05-06 02:33:47',NULL,NULL,'Y'),(7,5,5,'2026-05-06 17:48:32',NULL,NULL,'Y');
...
CREATE TABLE `response_detail` (
  ...
  `reg_user` int DEFAULT NULL COMMENT 'FK) users.user_no 등록자(로그인한 세션값 등록)',
  `reg_date` datetime DEFAULT CURRENT_TIMESTAMP COMMENT '등록일시',
  `mod_user` int DEFAULT NULL COMMENT 'FK) users.user_no 수정자',
  `mod_date` datetime DEFAULT NULL COMMENT '수정일시',
...
) ENGINE=InnoDB AUTO_INCREMENT=9 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='설문 응답 상세 (문항별 답변, 체크박스 복수선택시 행 여러개)';
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `response_detail` VALUES (1,2,36,'안녕하세요',NULL,0,NULL,NULL,NULL),(2,2,37,NULL,21,0,NULL,NULL,NULL),(3,3,36,'tttt',NULL,0,NULL,NULL,NULL),(4,3,37,NULL,23,0,NULL,NULL,NULL),(5,4,34,NULL,18,0,NULL,NULL,NULL),(6,4,35,'hgjghjg',NULL,0,NULL,NULL,NULL),(7,7,34,NULL,18,NULL,'2026-05-06 17:48:32',NULL,NULL),(8,7,35,'uuu',NULL,NULL,'2026-05-06 17:48:32',NULL,NULL);
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='시퀀스용 테이블';
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `sequences` VALUES ('BOARD_COMMON_SEQ',43);
...
CREATE TABLE `survey` (
  ...
  `mod_user` int DEFAULT NULL COMMENT 'FK) users.user_no 수정자',
  `mod_date` datetime DEFAULT NULL COMMENT '수정일시',
  `del_yn` char(1) DEFAULT 'N' COMMENT '삭제여부 (설문지는 사용여부가 따로 설정 할수 있어서 삭제체크용 컬럼다른 테이블의 use_yn가 대응)',
...
) ENGINE=InnoDB AUTO_INCREMENT=11 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='설문지 테이블';
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `survey` VALUES (5,'adasdsa','','2026-05-06 00:00:00','2026-05-07 00:00:00','Y',5,'2026-05-06 00:23:27',5,'2026-05-06 00:42:50','N'),(6,'qqqqqq3','','2026-05-06 00:00:00','2026-05-07 00:00:00','Y',5,'2026-05-06 00:26:49',NULL,NULL,'N'),(7,'ㅋㅌㅊ','ㅂㅈㄷㅎㅎ','2026-05-08 00:00:00','2026-05-09 00:00:00','Y',5,'2026-05-06 07:54:12',5,'2026-05-06 16:07:11','N'),(9,'ㅇㄹㅇㄹ','','2026-05-01 00:00:00','2026-05-02 00:00:00','Y',5,'2026-05-06 16:00:06',NULL,NULL,'N'),(10,'설문테스트입니다','설문에 성실히 답해주세요','2026-05-13 00:00:00','2026-05-14 00:00:00','Y',5,'2026-05-11 14:27:52',5,'2026-05-11 14:28:34','N');
...
CREATE TABLE `user_role` (
  ...
  `role_desc` text CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci COMMENT '롤에 대한 설명',
  `role_id` varchar(100) DEFAULT NULL COMMENT '역할 식별자 (예: D70001)',
  `admin_yn` char(1) DEFAULT NULL COMMENT '관리자 여부 (Y:관리자, N:일반)',
  `use_yn` char(1) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NOT NULL DEFAULT 'Y' COMMENT '사용여부 (Y:사용, N:미사용) 관리자가 직접 설정',
  `sort_ord` int DEFAULT NULL COMMENT '정렬 순서',
  `reg_date` datetime DEFAULT CURRENT_TIMESTAMP COMMENT '등록일시',
  `reg_user` int DEFAULT NULL COMMENT '등록자 (users.user_no)',
  `mod_date` datetime DEFAULT NULL COMMENT '수정일시',
  `mod_user` int DEFAULT NULL COMMENT '수정자 (users.user_no)',
  `del_yn` char(1) NOT NULL DEFAULT 'N' COMMENT '논리삭제 여부(목록 조회시 표시 안하기 위함)',
  PRIMARY KEY (`role_no`),
  UNIQUE KEY `user_role_unique` (`role_id`),
  KEY `fk_user_role_code` (`role_rank`),
  CONSTRAINT `fk_user_role_code` FOREIGN KEY (`role_rank`) REFERENCES `code` (`code_no`)
) ENGINE=InnoDB AUTO_INCREMENT=8 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='사용자 역할 테이블 (code 테이블과 연결)';
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `user_role` VALUES (1,'70020','일반사용자','','USER0001','Y','Y',3,'2026-05-05 06:32:57',NULL,'2026-05-11 15:33:36',5,'N'),(2,'70020','관리자','사용자관리자 ㅎㅎㅎㅎ','MGR0002','Y','Y',2,'2026-05-05 06:32:57',NULL,'2026-05-11 17:55:15',5,'N'),(3,'70030','시스템관리자','최상위 권한 그룹','SYSTEM','Y','Y',0,'2026-05-05 06:32:57',NULL,NULL,NULL,'N'),(7,'70010','테스트','ㅁㄴㅇㅁㄴㅇㅁㄴㅇ','USER0007','N','N',1,'2026-05-11 09:07:12',5,'2026-05-11 14:25:30',5,'N');
...
CREATE TABLE `users` (
  ...
  `user_id` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL COMMENT '로그인 아이디',
  `user_pw` varchar(200) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL COMMENT '비밀번호 (암호화)',
  `user_name` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL COMMENT '사용자명',
  `use_yn` char(1) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT 'Y' COMMENT '사용여부 (Y:사용, N:미사용)',
...
) ENGINE=InnoDB AUTO_INCREMENT=10 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='사용자 테이블';
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `users` VALUES (5,'root','1234','ROOT33335612312','Y',3,'2026-04-24 00:53:38',0,'2026-04-27 21:58:44',5),(6,'testuser','1234','테스트유저1111111111111111111111111','Y',2,'2026-04-26 08:39:12',5,'2026-05-11 09:10:22',5),(7,'testadmin','zxc123123!','adasd','Y',2,'2026-04-26 08:44:30',5,'2026-05-11 09:10:22',5),(8,'testadmin1','asd123123!','hhgfhgfsd','Y',2,'2026-04-26 08:48:19',5,'2026-05-11 09:10:22',5),(9,'test1231','ASD123123!','TEST123','Y',1,'2026-04-28 22:35:11',5,'2026-05-11 14:18:14',5);
...
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` FUNCTION `nextval`(the_name VARCHAR(32)) RETURNS bigint
    MODIFIES SQL DATA
    DETERMINISTIC
BEGIN
	DECLARE ret BIGINT;
...
/*!50003 SET sql_mode              = 'ONLY_FULL_GROUP_BY,STRICT_TRANS_TABLES,NO_ZERO_IN_DATE,NO_ZERO_DATE,ERROR_FOR_DIVISION_BY_ZERO,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` PROCEDURE `create_sequence`(IN the_name VARCHAR(32))
    MODIFIES SQL DATA
    DETERMINISTIC
BEGIN
	DELETE
...
/*!50003 SET character_set_results = @saved_cs_results */ ;
/*!50003 SET collation_connection  = @saved_col_connection */ ;
/*!50003 DROP PROCEDURE IF EXISTS `insert_dummy_users` */;
/*!50003 SET @saved_cs_client      = @@character_set_client */ ;
/*!50003 SET @saved_cs_results     = @@character_set_results */ ;
/*!50003 SET @saved_col_connection = @@collation_connection */ ;
/*!50003 SET character_set_client  = utf8mb4 */ ;
...
/*!50003 SET sql_mode              = 'ONLY_FULL_GROUP_BY,STRICT_TRANS_TABLES,NO_ZERO_IN_DATE,NO_ZERO_DATE,ERROR_FOR_DIVISION_BY_ZERO,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` PROCEDURE `insert_dummy_users`(IN p_count INT)
BEGIN
    ...
    SET reg_user = user_no
    	,mod_user = user_no
    WHERE reg_user IS NULL OR mod_user IS NULL;
...
-- Dump completed on 2026-05-11 18:09:42
