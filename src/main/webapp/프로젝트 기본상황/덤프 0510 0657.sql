...
) ENGINE=InnoDB AUTO_INCREMENT=46 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='메뉴별 롤 권한 관리 테이블';
/*!40101 SET character_set_client = @saved_cs_client */;
...
) ENGINE=InnoDB AUTO_INCREMENT=28 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='질문 보기(선택지) 테이블';
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `q_option` VALUES (18,34,'r1',0,NULL,'2026-05-06 00:23:27',NULL,NULL,'Y'),(19,34,'r2',1,NULL,'2026-05-06 00:23:27',NULL,NULL,'Y'),(20,34,'r3',2,NULL,'2026-05-06 00:23:27',NULL,NULL,'Y'),(21,37,'ㅅ1',0,NULL,'2026-05-06 00:26:49',NULL,NULL,'Y'),(22,37,'ㅅ2',1,NULL,'2026-05-06 00:26:49',NULL,NULL,'Y'),(23,37,'ㅅ3',2,NULL,'2026-05-06 00:26:49',NULL,NULL,'Y'),(24,38,'ㄱㄱㄱㄱ',0,NULL,'2026-05-06 07:54:12',NULL,NULL,'N'),(25,38,'ㄷㄷㄷㄷㄷ',1,NULL,'2026-05-06 07:54:12',NULL,NULL,'N'),(26,38,'ㄴㄴㄴㄴㄴ',0,NULL,'2026-05-06 07:54:12',NULL,NULL,'Y'),(27,41,'ㅂㅂㅂㅂ',0,NULL,'2026-05-06 16:00:06',NULL,NULL,'Y');
...
INSERT INTO `question` VALUES (34,5,'radio q','radio',0,NULL,5,'2026-05-06 00:23:27',5,'2026-05-06 00:42:50','Y'),(35,5,'aaaaa','textarea',1,NULL,5,'2026-05-06 00:23:27',5,'2026-05-06 00:42:50','Y'),(36,6,'단답질문','text',0,NULL,5,'2026-05-06 00:26:49',NULL,NULL,'Y'),(37,6,'셀렉트질문','select',1,NULL,5,'2026-05-06 00:26:49',NULL,NULL,'Y'),(38,7,'ㅓㅗㅓㅗㅓㅗ','radio',0,NULL,5,'2026-05-06 07:54:12',5,'2026-05-06 16:07:11','Y'),(39,7,'ㅎㅎㅎㅎ','textarea',1,NULL,5,'2026-05-06 07:54:12',5,'2026-05-06 16:07:11','Y'),(41,9,'ㄴㅁㅇ','radio',0,NULL,5,'2026-05-06 16:00:06',NULL,NULL,'Y');
...
INSERT INTO `sequences` VALUES ('BOARD_COMMON_SEQ',41);
...
) ENGINE=InnoDB AUTO_INCREMENT=10 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='설문지 테이블';
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `survey` VALUES (5,'adasdsa','','2026-05-06 00:00:00','2026-05-07 00:00:00','Y',5,'2026-05-06 00:23:27',5,'2026-05-06 00:42:50','N'),(6,'qqqqqq3','','2026-05-06 00:00:00','2026-05-07 00:00:00','Y',5,'2026-05-06 00:26:49',NULL,NULL,'N'),(7,'ㅋㅌㅊ','ㅂㅈㄷㅎㅎ','2026-05-08 00:00:00','2026-05-09 00:00:00','Y',5,'2026-05-06 07:54:12',5,'2026-05-06 16:07:11','N'),(9,'ㅇㄹㅇㄹ','','2026-05-01 00:00:00','2026-05-02 00:00:00','Y',5,'2026-05-06 16:00:06',NULL,NULL,'N');
...
) ENGINE=InnoDB AUTO_INCREMENT=13 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='사용자 역할 테이블 (code 테이블과 연결)';
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `user_role` VALUES (1,'70010','일반사용자',NULL,'USER0001','N','Y',1,'2026-05-05 06:32:57',NULL,NULL,NULL,'N'),(2,'70020','관리자','사용자관리자','U70020','Y','Y',2,'2026-05-05 06:32:57',NULL,NULL,NULL,'N'),(3,'70030','시스템관리자','최상위 권한 그룹','U70030','Y','Y',3,'2026-05-05 06:32:57',NULL,NULL,NULL,'N'),(4,'70010','테스트','테스트일반사용자','U70040','N','Y',4,'2026-05-05 06:32:57',NULL,NULL,NULL,'N'),(6,'70020','그룹관리자','그룹 관리관련 권한','U70050','N','Y',0,'2026-05-08 14:53:19',5,NULL,NULL,'N'),(11,'70010','ㅇㄹ','ㅇㅇ','USER0011','N','Y',1,'2026-05-10 05:03:16',5,NULL,NULL,'N'),(12,'70020','ㅎㄹㅇㅎ','ㅇㅀ','MGR0012','Y','Y',1,'2026-05-10 05:03:43',5,NULL,NULL,'N');
...
-- Dump completed on 2026-05-10  6:48:15
